...
class AulaAgendada extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $url .= '&details=Aula+de+' . $this->agendamento->aula->categoria->nome . '%2C+com+o+Professor+' . $this->agendamento->professor->fullName . '%2C+das+' . $this->agendamento->inicio . '+%C3%A0s+' . $this->agendamento->fim;
