...
! function(n) {
    ...
    s.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, s.MODULES = {}, s.PLUGINS = {}, s.VERSION = "2.9.2", s.INSTANCES = [], s.OPTS_MAPPING = {}, s.SHARED = {}, s.ID = 0, s.prototype._init = function() {
    ...
    Ee.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", Ee.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", Ee.FE.LinkRegExTLD = "((" + Ee.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", Ee.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExWWW = "(www\\." + Ee.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", Ee.FE.LinkRegEx = "(" + Ee.FE.LinkRegExTLD + "|" + Ee.FE.LinkRegExHTTP + "|" + Ee.FE.LinkRegExWWW + "|" + Ee.FE.LinkRegExAuth + ")" + Ee.FE.LinkRegExEnd, Ee.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Ee.FE.MAIL_REGEX = /.+@.+\..+/i, Ee.FE.MODULES.helpers = function(a) {
        ...
        function n(e) {
            ...
            if (!l.core.hasFocus() && e) {
                ...
                if (l.browser.msie && l.$box && l.$box.css("position", "fixed"), l.browser.msie && l.$wp && l.$wp.css("overflow", "visible"), s(), l.$el.focus(), l.events.trigger("focus"), a(), l.browser.msie && l.$box && l.$box.css("position", ""), l.browser.msie && l.$wp && l.$wp.css("overflow", "auto"), n != l.$win.scrollTop() && l.$win.scrollTop(n), !l.selection.info(l.el).atStart) return !1
            }
        ...
        function a(e, t) {
            ...
            for (r.setAttribute("id", "fr-sel-markers"), r.innerHTML = Ee.FE.MARKERS; T.opts.htmlAllowedEmptyTags && 0 <= T.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());) e = e.parentNode;
            e.appendChild(r);
            ...
            lists: function() {
                ...
                function() {
                    for (var e = c.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
                        for (var n = c.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName && "UL" != n[i].tagName && "OL" != n[i].tagName ? (r || (r = Ee("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
                }(),
                function() {
                    var e, t, n;
                    do {
        ...
        return {
            ...
            get: function(e, t) {
                ...
                var w = N.events.chainTrigger("html.get", n);
            ...
            insert: function(e, t, n) {
                var r, i, a;
                if (N.selection.isCollapsed() || N.selection.remove(), r = t ? e : N.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (i = r, (a = N.doc.createElement("div")).innerHTML = i, N.selection.setAtEnd(a), r = a.innerHTML), N.node.isEmpty(N.el) && !N.opts.keepFormatOnDelete && f(r)) N.el.innerHTML = r;
                else {
        ...
        function t(e) {
            ...
            if (C.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (S = "", /text\/rtf/.test(t) && (o = e.clipboardData.getData("text/rtf")), /text\/html/.test(t) && !C.browser.safari ? S = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && C.browser.safari ? S = o : /public.rtf/.test(t) && C.browser.safari && (S = e.clipboardData.getData("text/rtf")), !/text\/plain/.test(t) || C.browser.safari || S || (R = !0, S = e.clipboardData.getData("text/plain")), "" !== S) return s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                S = null
            }
            return function() {
        ...
        function r(e) {
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (S = "", /text\/rtf/.test(t) && (o = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? S = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && C.browser.safari ? S = o : /text\/plain/.test(t) && !this.browser.mozilla && (S = C.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== S) {
                    C.keys.forceUndo(), y = C.snapshot.get(), C.selection.save(), C.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
        ...
        function s() {
            C.browser.edge && C.opts.iframe && C.$box.after(i), y || (C.keys.forceUndo(), y = C.snapshot.get()), S || (S = i.get(0).innerHTML, C.selection.restore(), C.events.enableBlur());
        ...
        function l(r, e, t) {
            ...
            if (!e && (c = function(e) {
                ...
                C.opts.htmlAllowedStyleProps = C.opts.pasteAllowedStyleProps, C.opts.htmlAllowComments = !1, r = (r = (r = r.replace(/<span class="Apple-tab-span">\s*<\/span>/g, L(C.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function(e, t) {
                    return L(t.length * (C.opts.tabSpaces || 4))
                })).replace(/\t/g, L(C.opts.tabSpaces || 4)), r = C.clean.html(r, C.opts.pasteDeniedTags, C.opts.pasteDeniedAttrs), C.opts.htmlAllowedStyleProps = p, C.opts.htmlAllowComments = !0, r = (r = (r = w(r)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
            }!e || C.wordPaste && t || (0 === (r = r.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = w(r = function(e) {
                var t;
            ...
            }(r))), C.opts.pastePlain && !c ? r = _(r) : R && r && (r = _(r), R = !1);
            ...
            C.events.trigger("paste.after"), C.undo.saveStep(y), y = null, C.undo.saveStep()
        }
        ...
        function w(r, e) {
            ...
            for (var _, L, w = {
                    "{": function(e) {
                        w.singleSpace(), x.push(e), w.newLine()
                    },
                    "}": function(e) {
                        w.newLine(), x.push(e), w.newLine()
                    },
                    ...
                    singleSpace: function() {
                        x.length && !w._lastCharWhitespace() && x.push(" ")
                    },
                    preserveSingleSpace: function() {
                        M && w.singleSpace()
                    },
                    trim: function() {
                        for (; w._lastCharWhitespace();) x.pop()
                    }
                }, x = [], N = !1, O = !1, I = !1, D = "", k = "";;) {
                var F = E(),
                    M = "" !== F,
        ...
        function i(r, e) {
            ...
            for (u = {
                    ...
                    TK_END_EXPR: function() {
                        ...
                        "]" === s.text && h.keep_array_indentation ? (S(), w()) : (w(), S());
                    ...
                    TK_SEMICOLON: function() {
                        ...
                        for (; f.mode === k.Statement && !f.if_block && !f.do_block;) w();
                        S()
                    },
                    TK_STRING: function() {
                        N() ? o.space_before_token = !0 : "TK_RESERVED" === l || "TK_WORD" === l ? o.space_before_token = !0 : "TK_COMMA" === l || "TK_START_EXPR" === l || "TK_EQUALS" === l || "TK_OPERATOR" === l ? x() || T() : A();
                        S()
                    },
                    TK_EQUALS: function() {
                        N();
                    ...
                    TK_COMMA: function() {
                        ...
                        S(), f.mode === k.ObjectLiteral || f.mode === k.Statement && f.parent.mode === k.ObjectLiteral ? (f.mode === k.Statement && w(), A()) : (o.space_before_token = !0, h.comma_first && T())
                    },
            ...
            function N() {
                return !!("TK_RESERVED" === l && G(f.last_text, ["var", "let", "const"]) && "TK_WORD" === s.type || "TK_RESERVED" === l && "do" === f.last_text || "TK_RESERVED" === l && "return" === f.last_text && !s.wanted_newline || "TK_RESERVED" === l && "else" === f.last_text && ("TK_RESERVED" !== s.type || "if" !== s.text) || "TK_END_EXPR" === l && (p.mode === k.ForInitializer || p.mode === k.Conditional) || "TK_WORD" === l && f.mode === k.BlockStatement && !f.in_case && "--" !== s.text && "++" !== s.text && "function" !== d && "TK_WORD" !== s.type && "TK_RESERVED" !== s.type || f.mode === k.ObjectLiteral && (":" === f.last_text && 0 === f.ternary_depth || "TK_RESERVED" === l && G(f.last_text, ["get", "set"]))) && (y(k.Statement), R(), "TK_RESERVED" === l && G(f.last_text, ["var", "let", "const"]) && "TK_WORD" === s.type && (f.declaration_statement = !0), x() || T("TK_RESERVED" === s.type && G(s.text, ["do", "for", "if", "while"])), !0)
            }
        ...
        function M(y, _, e) {
            ...
            function o() {
                ...
                if (n.length && (D = n.join("")), w.test(r)) {
                    var i = !0,
                        a = !0,
                        o = w;
                    for ("0" === r && M < $ && /[Xxo]/.test(y.charAt(M)) ? (a = i = !1, r += y.charAt(M), M += 1, o = /[o]/.test(y.charAt(M)) ? x : N) : (r = "", M -= 1); M < $ && o.test(y.charAt(M));) r += y.charAt(M), M += 1, i && M < $ && "." === y.charAt(M) && (r += y.charAt(M), M += 1, i = !1), a && M < $ && /[Ee]/.test(y.charAt(M)) && (r += y.charAt(M), (M += 1) < $ && /[+-]/.test(y.charAt(M)) && (r += y.charAt(M), M += 1), i = a = !1);
                    return [r, "TK_WORD"]
                }
                        ...
                        case "TK_SCRIPT":
                            if ("" !== n.token_text) {
                                ...
                                var A, C = n.token_text,
                                    S = 1;
                                "TK_SCRIPT" == n.token_type ? A = x : "TK_STYLE" == n.token_type && (A = w), "keep" == t.indent_scripts ? S = 0 : "separate" == t.indent_scripts && (S = -n.indent_level);
    ...
    if (Ee.FE.PLUGINS.colors = function(g) {
            ...
            function C() {
                if (l || function() {
                        ...
                        f.events.on("shared.destroy", function() {
                            ...
                            p && !p.hasClass("fr-uploading") ? oe(!0) : p && (C(), ue(), x(!1))
                        });
            ...
            function k(o, e, s, l, d) {
                ...
                t.onload = function() {
                    ...
                    L(r)
                }, x(f.language.translate("Loading image")), t.src = o
            }
                    ...
                    if (f.drag_support.formdata && (n = f.drag_support.formdata ? new FormData : null), n) {
                        ...
                        f.opts.imageUploadToS3 && (a = f.opts.imageUploadToS3.uploadURL ? f.opts.imageUploadToS3.uploadURL : "https://" + f.opts.imageUploadToS3.region + ".amazonaws.com/" + f.opts.imageUploadToS3.bucket),
                            function(t, n, e, i) {
                                function a() {
                                    var e = Ee(this);
                                    e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), f.placeholder.refresh(), I(e), C(), x(), f.edit.off(), t.onload = function() {
                                        F.call(t, e)
            ...
            function H(e) {
                ...
                if (t && t.files && t.files.length) {
                    ...
                    if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                        ...
                        return f.opts.iframe && (a += f.$iframe.offset().top, i += f.$iframe.offset().left), f.popups.show("image.insert", i, a), x(), 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) ? (oe(!0), U(t.files)) : L(E), e.preventDefault(), e.stopPropagation(), !1
                    }
                }
            }
            ...
            function ee(e) {
                ...
                p = Ee(e), C(), a(), ue(), x(), p.one("load", function() {
                    C(), x()
                });
            ...
            return {
                _init: function() {
                    ...
                    f.events.$on(f.$el, f._mousedown, "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function(e) {
                        ...
                        e.nodeType === Node.TEXT_NODE && (e = e.parentNode), f.node.hasClass(e, "fr-inner") || (f.node.hasClass(e, "fr-img-caption") || (e = Ee(e).parents(".fr-img-caption").get(0)), Ee(e).after(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS), f.selection.restore())
                    ...
                    }), w(!0), W(!0), q(!0), G(!0), f.events.on("node.remove", function(e) {
                ...
                setSize: function(e, t) {
                    if (p) {
                        ...
                        var r = /^[\d]+((px)|%)*$/g;
                        p.removeAttr("width").removeAttr("height"), e.match(r) ? p.css("width", e) : p.css("width", ""), t.match(r) ? p.css("height", t) : p.css("height", ""), ve() && (p.parent().removeAttr("width").removeAttr("height"), e.match(r) ? p.parent().css("width", e) : p.parent().css("width", ""), t.match(r) ? p.parent().css("height", t) : p.parent().css("height", "")), n && n.find("input:focus").blur(), I(p)
                    }
                },
            ...
            function t(i) {
                ...
                x(!1), a.onload = function() {
                    ...
                    o.append(n).append(Ee(s.icon.create("imageManagerDelete")).addClass("fr-delete-img").attr("title", s.language.translate("Delete"))).append(Ee(s.icon.create("imageManagerInsert")).addClass("fr-insert-img").attr("title", s.language.translate("Insert"))), c.find(".fr-selected-tag").each(function(e, t) {
                        ...
                        o.removeClass("fr-empty"), o.height("auto"), p++, w(L(parseInt(n.parent().attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), x(!1), p % s.opts.imageManagerPageSize == 0 && y()
                    }), s.events.trigger("imageManager.imageLoaded", [n])
                }, a.onerror = function() {
                    p++, o.remove(), w(L(parseInt(o.attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), D(e, i), p % s.opts.imageManagerPageSize == 0 && y()
            ...
            function I(e) {
                ...
                confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), Ee.ajax({
                    ...
                    n.parent().remove(), w(t), l.find("#fr-modal-tags > a").each(function() {
    ...
    Ee.FE.DEFAULTS.imageInsertButtons.push("imageManager"), Ee.FE.RegisterCommand("imageManager", {
            ...
            for (var n in t)
                if (t.hasOwnProperty(n)) {
                    var r = this.shortcuts.get("quote." + n),
                        i = ' title="' + t[n];
                    r && (i += " (" + r + ")"), e += '<li role="presentation"><a class="fr-command fr-title fr-active ' + n + '" tabIndex="-1" role="option" data-cmd="quote" data-param1="' + n + '"' + (i += '"') + ">" + this.language.translate(t[n]) + "</a></li>"
                }
            return e += "</ul>"
        },
        callback: function(e, t) {
        ...
        function e(e) {
            ...
            if (0 < Q().length && !t && D(), !T.edit.isDisabled() || T.popups.isVisible("table.edit"))
                ...
                e.shiftKey && 0 < T.$el.find(n + ".fr-selected-cell").length ? Ee(T.$el.find(n + ".fr-selected-cell").closest("table")).is(Ee(t).closest("table")) ? O(r, t) : w() : ((T.keys.ctrlKey(e) || e.shiftKey) && (1 < Q().length || 0 === Ee(t).find(T.selection.element()).length && !Ee(t).is(T.selection.element())) && w(), r = t, 0 < T.opts.tableEditButtons.length && O(r, r))
            }
        }
            ...
            if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < n.closest("td").length ? t = n.closest("td") : 0 < n.closest("th").length && (t = n.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName) A && n.get(0) != A.get(0) && n.parent().get(0) != A.get(0) && T.core.sameInstance(A) && B();
                ...
                if (Math.abs(e.pageX - a) <= T.opts.tableResizerOffset || Math.abs(o - e.pageX) <= T.opts.tableResizerOffset) {
                    ...
                    "rtl" != T.opts.direction ? e.pageX - a <= T.opts.tableResizerOffset ? (d = a, 0 < u.col ? (c = a - Y(u.col - 1, p) + T.opts.tableResizingLimit, f = a + Y(u.col, p) - T.opts.tableResizingLimit, s = u.col - 1, l = u.col) : (s = null, l = 0, c = r.offset().left - 1 - parseInt(r.css("margin-left"), 10), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)) : o - e.pageX <= T.opts.tableResizerOffset && (d = o, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = o - Y(h.col, p) + T.opts.tableResizingLimit, f = o + Y(h.col + 1, p) - T.opts.tableResizingLimit, s = h.col, l = h.col + 1) : (s = h.col, l = null, c = r.offset().left - 1 + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : o - e.pageX <= T.opts.tableResizerOffset ? (d = o, 0 < u.col ? (c = o - Y(u.col, p) + T.opts.tableResizingLimit, f = o + Y(u.col - 1, p) - T.opts.tableResizingLimit, s = u.col, l = u.col - 1) : (s = null, l = 0, c = r.offset().left + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : e.pageX - a <= T.opts.tableResizerOffset && (d = a, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = a - Y(h.col + 1, p) + T.opts.tableResizingLimit, f = a + Y(h.col, p) - T.opts.tableResizingLimit, s = h.col + 1, l = h.col) : (s = h.col, l = null, c = i.offset().left + parseFloat(i.css("padding-left")), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)), A || (T.shared.$table_resizer || (T.shared.$table_resizer = Ee('<div class="fr-table-resizer"><div></div></div>')), A = T.shared.$table_resizer, T.events.$on(A, "mousedown", function(e) {
                        return !T.core.sameInstance(A) || (0 < Q().length && D(), 1 == e.which ? (T.selection.save(), b = !0, A.addClass("fr-moving"), w(), T.edit.off(), A.find("div").css("opacity", 1), !1) : void 0)
        ...
        function V(e) {
            if (1 < Q().length && a && w(), !1 === a && !1 === i && !1 === b) o && clearTimeout(o), T.edit.isDisabled() && !T.popups.isVisible("table.edit") || (o = setTimeout(W, 30, e));
            else if (b) {
        ...
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vidyard"
    }], Ee.FE.VIDEO_EMBED_REGEX = /^\W*((<iframe(.|\n)*>(\s|\n)*<\/iframe>)|(<embed(.|\n)*>))\W*$/i, Ee.FE.PLUGINS.video = function(f) {
        var s, c, p, u, r, n, l = "https://i.froala.com/upload",
            d = 2,
            h = 3,
            g = 4,
            m = 5,
        ...
        function U(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (f.drag_support.formdata && (t = f.drag_support.formdata ? new FormData : null), t) {
                    ...
                    a.onload = function() {
                        _.call(a, u)
                    }, a.onerror = L, a.upload.onprogress = w, a.onabort = x, C(), f.events.disableBlur(), f.edit.off(), f.events.enableBlur();
                        ...
                        if (C(t)) {
                            var n = t.parentNode,
                                ...
                                i = function e(t, n) {
                                    ...
                                    null != f && (s = f.previousElementSibling);
                                    var p = t.parentNode;
                                    A(t);
                                    t = null;
                                    for (; f && C(f);) {
                                        var u = v(f);
                                        if (d < u) c += e(f, n).outerHTML;
                                        else {
                                            if (u < d) break;
                                            f.firstElementChild && f.firstElementChild.firstElementChild && f.firstElementChild.firstElementChild.firstChild && (r.lastIndex = 0, a = r.test(f.firstElementChild.firstElementChild.firstChild.data || "")), s && s.firstElementChild && s.firstElementChild.firstElementChild && s.firstElementChild.firstElementChild.firstChild && (r.lastIndex = 0, o = r.test(s.firstElementChild.firstElementChild.firstChild.data || "")), o === undefined || o === a ? c += "</li><li>" + E(f, n) : c += e(f, n).outerHTML
                                        }
                                        if (d = u, f.previousElementSibling || f.nextElementSibling || f.parentNode) {
                                            var h = f;
                                            f = f.nextElementSibling, A(h), h = null
                                        } else f = s ? s.nextElementSibling : p.firstElementChild
                                    }
                                    c += "</li></" + l + ">";
