...
!function(a) {
  ...
  be.FE.PLUGINS.image = function(g) {
      var d, l, f, p, o, a, c = "https://i.froala.com/upload", t = !1, i = 1, u = 2, m = 3, h = 4, v = 5, b = 6, r = {};
      function y() {
      ...
      function e() {
          for (var e, t, a = "IMG" == g.el.tagName ? [g.el] : g.el.querySelectorAll("img"), i = 0; i < a.length; i++) {
              var r = be(a[i]);
              !g.opts.htmlUntouched && g.opts.useClasses ? ((g.opts.imageDefaultAlign || g.opts.imageDefaultDisplay) && (0 < (t = r).parents(".fr-img-caption").length && (t = t.parents(".fr-img-caption:first")),
              t.hasClass("fr-dii") || t.hasClass("fr-dib") || (t.addClass("fr-fi" + ge(t)[0]),
              ...
              g.opts.imageTextNear || (0 < r.parents(".fr-img-caption").length ? r.parents(".fr-img-caption:first").removeClass("fr-dii").addClass("fr-dib") : r.removeClass("fr-dii").addClass("fr-dib"))) : g.opts.htmlUntouched || g.opts.useClasses || (g.opts.imageDefaultAlign || g.opts.imageDefaultDisplay) && (0 < (e = r).parents(".fr-img-caption").length && (e = e.parents(".fr-img-caption:first")),
              pe(e, e.hasClass("fr-dib") ? "block" : e.hasClass("fr-dii") ? "inline" : null, e.hasClass("fr-fil") ? "left" : e.hasClass("fr-fir") ? "right" : ge(e)),
      ...
      function E(e) {
          ...
          for (t = 0; t < a.length; t++)
              if (i.push(a[t].getAttribute("src")),
          ...
          if (o)
              for (t = 0; t < o.length; t++)
                  i.indexOf(o[t].getAttribute("src")) < 0 && g.events.trigger("image.removed", [be(o[t])]);
          if (o && e) {
              var s = [];
              for (t = 0; t < o.length; t++)
      ...
      function C() {
          if (l || function() {
              var e;
              g.shared.$image_resizer ? (l = g.shared.$image_resizer,
              p = g.shared.$img_overlay,
              g.events.on("destroy", function() {
                  l.removeClass("fr-active").appendTo(be("body:first"))
              }, !0)) : (g.shared.$image_resizer = be('<div class="fr-image-resizer"></div>'),
              l = g.shared.$image_resizer,
              g.events.$on(l, "mousedown", function(e) {
                  e.stopPropagation()
              }, !0),
              g.opts.imageResize && (l.append(s("nw") + s("ne") + s("sw") + s("se")),
              g.shared.$img_overlay = be('<div class="fr-image-overlay"></div>'),
              p = g.shared.$img_overlay,
              e = l.get(0).ownerDocument,
              be(e).find("body:first").append(p)));
              g.events.on("shared.destroy", function() {
                  l.html("").removeData().remove(),
                  l = null,
                  g.opts.imageResize && (p.remove(),
                  p = null)
              }, !0),
              g.helpers.isMobile() || g.events.$on(be(g.o_win), "resize", function() {
                  d && !d.hasClass("fr-uploading") ? se(!0) : d && (C(),
                  ce(),
                  I(!1))
              });
              if (g.opts.imageResize) {
                  ...
                  g.events.$on(be(e.defaultView || e.parentWindow), g._mouseup, D),
                  g.events.$on(p, "mouseleave", D);
                  var i = 1
                    , r = null
                    , n = 0;
                  g.events.on("keydown", function(e) {
                      if (d) {
                          ...
                          (a == be.FE.KEYCODE.EQUALS || g.browser.mozilla && a == be.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? i = q.call(this, e, 1, 1, i) : (a == be.FE.KEYCODE.HYPHEN || g.browser.mozilla && a == be.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey ? i = q.call(this, e, 2, -1, i) : g.keys.ctrlKey(e) || a != be.FE.KEYCODE.ENTER || (d.before("<br>"),
                          k(d)),
                          r = a,
                          n = e.timeStamp
                      }
          ...
          l.css("top", (g.opts.iframe ? i.offset().top : i.offset().top + t) - 1).css("left", (g.opts.iframe ? i.offset().left : i.offset().left + a) - 1).css("width", i.get(0).getBoundingClientRect().width).css("height", i.get(0).getBoundingClientRect().height).addClass("fr-active")
      }
      function s(e) {
      ...
      function S(e) {
          ...
          if (f && d) {
              ...
              if ((f.hasClass("fr-hnw") || f.hasClass("fr-hsw")) && (i = 0 - i),
              g.opts.imageResizeWithPercent) {
                  ...
                  A(r + "%"),
                  (t = ve() ? (g.helpers.getPX(d.parents(".fr-img-caption").css("width")) / be(n).outerWidth() * 100).toFixed(2) : (g.helpers.getPX(d.css("width")) / be(n).outerWidth() * 100).toFixed(2)) === r || g.opts.imageRoundPercent || A(t + "%"),
                  d.css("height", "").removeAttr("height")
              } else
                  r + i >= g.opts.imageMinWidth && (A(r + i),
                  t = ve() ? g.helpers.getPX(d.parents(".fr-img-caption").css("width")) : g.helpers.getPX(d.css("width"))),
                  t !== r + i && A(t),
                  ((d.attr("style") || "").match(/(^height:)|(; *height:)/) || d.attr("height")) && (d.css("height", f.data("start-height") * d.width() / f.data("start-width")),
                  d.removeAttr("height"));
              C(),
              g.events.trigger("image.resize", [me()])
          }
      }
      function D(e) {
          if (!g.core.sameInstance(l))
      ...
      function U(e) {
          if (e)
              return g.$wp && g.events.$on(g.$wp, "scroll.image-edit", function() {
                  d && g.popups.isVisible("image.edit") && (g.events.disableBlur(),
                  n())
              }),
              !0;
          var t = "";
          if (0 < g.opts.imageEditButtons.length) {
              ...
              t += g.button.buildList(g.opts.imageEditButtons);
              var a = {
                  buttons: t += "</div>"
              };
      ...
      function $(e) {
          ...
          e || g.$el.find("img.fr-error").length)) {
              if (g.events.focus(),
              g.$el.find("img.fr-error").length && (g.$el.find("img.fr-error").remove(),
              g.undo.saveStep(),
              g.undo.run(),
              g.undo.dropRedo()),
              !g.$wp && d) {
      ...
      function F(e, t) {
          ...
          if (a) {
              ...
              i.find("div > span").css("width", t + "%")) : i.find("div").addClass("fr-indeterminate")
          }
      }
      function k(e) {
          ne.call(e.get(0))
      ...
      function O(s, e, o, l, f) {
          ...
          t.onload = function() {
              ...
              if (l) {
                  ...
                  g.$wp ? ((e = l.clone().removeData("fr-old-src").removeClass("fr-uploading").removeAttr("data-fr-image-pasted")).off("load"),
                  a && l.attr("src", a),
                  l.replaceWith(e)) : e = l;
          ...
          ,
          I(g.language.translate("Loading image")),
          t.src = s
      }
      function N(e) {
          F(g.language.translate("Loading image"));
                  ...
                  if (201 == t) {
                      var n = function(e) {
                          try {
                              ...
                              return !1 === g.events.trigger("image.uploadedToS3", [t, a, e], !0) ? (g.edit.on(),
                              !1) : t
                          } catch (i) {
                              return x(h, e),
                              !1
      ...
      function L(e, t, a) {
          ...
          return o.length ? (o.parent().is("hr") && o.parent().after(o),
          g.node.isLastSibling(o) && o.parent().hasClass("fr-deletable") && o.insertAfter(o.parent()),
          o.replaceWith(s)) : g.$el.append(s),
          g.selection.clear(),
          s
      }
      function M() {
      ...
      function z(e, t) {
          if (void 0 !== e && 0 < e.length) {
              if (!1 === g.events.trigger("image.beforeUpload", [e, t]))
                  return !1;
              var a, i = e[0];
              if ((null === g.opts.imageUploadURL || g.opts.imageUploadURL == c) && !g.opts.imageUploadToS3)
                  ...
                  l.readAsDataURL(s),
                  !1;
              if (i.name || (i.name = (new Date).getTime() + "." + (i.type || "image/jpeg").replace(/image\//g, "")),
              i.size > g.opts.imageMaxSize)
                  return x(v),
                  !1;
              if (g.opts.imageAllowedTypes.indexOf(i.type.replace(/image\//g, "")) < 0)
                  return x(b),
                  !1;
              if (g.drag_support.formdata && (a = g.drag_support.formdata ? new FormData : null),
              a) {
                  var r;
      ...
      function K(e) {
          ...
          if (t && t.files && t.files.length) {
              ...
              if (a && a.type && -1 !== a.type.indexOf("image") && 0 <= g.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, ""))) {
                  ...
                  return g.opts.iframe && (n += g.$iframe.offset().top,
                  r += g.$iframe.offset().left),
                  g.popups.show("image.insert", r, n),
                  I(),
                  0 <= g.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, "")) ? (se(!0),
                  z(t.files)) : x(b),
                  e.preventDefault(),
                  e.stopPropagation(),
                  !1
      ...
      function W(e) {
          if (e)
              return g.popups.onRefresh("image.insert", y),
          ...
          0 <= s && (t = " fr-active",
          0 <= n && n < s && (t = ""),
          l = '<div class="fr-image-by-url-layer' + t + ' fr-layer" id="fr-image-by-url-layer-' + g.id + '"><div class="fr-input-line"><input id="fr-image-by-url-layer-text-' + g.id + '" type="text" placeholder="http://" tabIndex="1" aria-required="true"></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="imageInsertByURL" tabIndex="2" role="button">' + g.language.translate("Insert") + "</button></div></div>");
          var f, p = {
              buttons: i,
              upload_layer: o,
              by_url_layer: l,
          ...
          return 1 <= g.opts.imageInsertButtons.length && (a = g.popups.create("image.insert", p)),
          g.$wp && g.events.$on(g.$wp, "scroll", function() {
              d && g.popups.isVisible("image.insert") && ce()
          }),
          f = a,
          g.events.$on(f, "dragover dragenter", ".fr-image-upload-layer", function() {
              return be(this).addClass("fr-drop"),
              !1
          }, !0),
          g.events.$on(f, "dragleave dragend", ".fr-image-upload-layer", function() {
              return be(this).removeClass("fr-drop"),
              !1
          }, !0),
          g.events.$on(f, "drop", ".fr-image-upload-layer", function(e) {
              e.preventDefault(),
              e.stopPropagation(),
              be(this).removeClass("fr-drop");
              var t = e.originalEvent.dataTransfer;
              if (t && t.files) {
          ...
          g.helpers.isIOS() && g.events.$on(f, "touchstart", '.fr-image-upload-layer input[type="file"]', function() {
              be(this).trigger("click")
          }, !0),
          g.events.$on(f, "change", '.fr-image-upload-layer input[type="file"]', function() {
              if (this.files) {
      ...
      function X(e) {
          if (e)
              return g.popups.onRefresh("image.alt", H),
              !0;
          var t = {
      ...
      function j() {
          ...
          if (d)
              if (ve()) {
                  ...
                  e.find('input[name="width"]').val(t.get(0).style.width).trigger("change"),
                  e.find('input[name="height"]').val(t.get(0).style.height).trigger("change")
              } else
                  e.find('input[name="width"]').val(d.get(0).style.width).trigger("change"),
                  e.find('input[name="height"]').val(d.get(0).style.height).trigger("change")
      }
      function G() {
          var e = g.popups.get("image.size");
          e || (e = V()),
      ...
      function V(e) {
          if (e)
              return g.popups.onRefresh("image.size", j),
              !0;
          var t = {
      ...
      function Q(e) {
          (e = e || he()) && !1 !== g.events.trigger("image.beforeRemove", [e]) && (g.popups.hideAll(),
          ue(),
          se(!0),
          g.undo.canDo() || g.undo.saveStep(),
          e.get(0) == g.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (g.selection.setBefore(e.get(0).parentNode) || g.selection.setAfter(e.get(0).parentNode) || e.parent().after(be.FE.MARKERS),
          be(e.get(0).parentNode).remove()) : (g.selection.setBefore(e.get(0)) || g.selection.setAfter(e.get(0)) || e.after(be.FE.MARKERS),
          e.remove()),
          g.html.fillEmptyBlocks(),
          g.selection.restore()),
          g.undo.saveStep()),
          e.attr('src', e.data('reset'));
      }
      function J(e) {
          var t = e.which;
          ...
          return d && t != be.FE.KEYCODE.F10 && !g.keys.isBrowserAction(e) ? (e.preventDefault(),
          e.stopPropagation(),
          !1) : void 0
      }
      function Z(e) {
          if (e && "IMG" == e.tagName) {
              if (g.node.hasClass(e, "fr-uploading") || g.node.hasClass(e, "fr-error") ? e.parentNode.removeChild(e) : g.node.hasClass(e, "fr-draggable") && e.classList.remove("fr-draggable"),
              ...
              for (var i = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), r = 0; r < i.length; r++)
                  Z(i[r])
      }
      function ee(e) {
          if (!1 === g.events.trigger("image.beforePasteUpload", [e]))
              return !1;
          d = be(e),
          C(),
          n(),
          ...
          for (var t = be(e).attr("src").split(","), a = atob(t[1]), i = [], r = 0; r < a.length; r++)
      ...
      function te() {
          g.opts.imagePaste ? g.$el.find("img[data-fr-image-pasted]").each(function(e, a) {
              if (g.opts.imagePasteProcess) {
                  ...
                  be(a).css("width", t).removeClass("fr-dii fr-dib fr-fir fr-fil"),
                  pe(be(a), g.opts.imageDefaultDisplay, g.opts.imageDefaultAlign)
              }
              if (0 === a.src.indexOf("data:"))
                  ee(a);
              else if (0 === a.src.indexOf("blob:") || 0 === a.src.indexOf("http") && g.opts.imageUploadRemoteUrls && g.opts.imageCORSProxy) {
                  var i = new Image;
                  ...
                  i.onload = function() {
                      ...
                      a.src = e.toDataURL("image/jpeg")
                  }
                  ,
                  i.src = (0 === a.src.indexOf("blob:") ? "" : g.opts.imageCORSProxy + "/") + a.src
              } else
                  0 !== a.src.indexOf("http") || 0 === a.src.indexOf("https://mail.google.com/mail") ? (g.selection.save(),
                  be(a).remove(),
                  g.selection.restore()) : be(a).removeAttr("data-fr-image-pasted")
      ...
      function ae(e) {
          ...
          g.undo.saveStep(),
          g.html.insert('<img data-fr-image-pasted="true" src="' + t + '"' + (a ? ' style="width: ' + a + ';"' : "") + ">");
      ...
      function ie(e) {
          if (e && e.clipboardData && e.clipboardData.items) {
              var t = null;
              if (e.clipboardData.types && -1 != e.clipboardData.types.indexOf("text/rtf") || e.clipboardData.getData("text/rtf"))
      ...
      function ne(e) {
          ...
          e && (e.stopPropagation(),
          e.preventDefault()),
          g.helpers.isMobile() && (g.events.disableBlur(),
          g.$el.blur(),
          g.events.enableBlur()),
          ...
          C(),
          n(),
          g.browser.msie ? (g.popups.areVisible() && g.events.disableBlur(),
          g.win.getSelection && (g.win.getSelection().removeAllRanges(),
          g.win.getSelection().addRange(g.doc.createRange()))) : g.selection.clear(),
          g.helpers.isIOS() && (g.events.disableBlur(),
          g.$el.blur()),
          g.button.bulkRefresh(),
          g.events.trigger("video.hideResizer")
      }
      function se(e) {
          d && (oe || !0 === e) && (g.toolbar.enable(),
      ...
      function pe(e, t, a) {
          !g.opts.htmlUntouched && g.opts.useClasses ? (e.removeClass("fr-fil fr-fir fr-dib fr-dii"),
          a && e.addClass("fr-fi" + a[0]),
          t && e.addClass("fr-di" + t[0])) : "inline" == t ? (e.css({
      ...
      return {
          _init: function() {
              ...
              g.events.$on(g.$el, g._mousedown, "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', function(e) {
                  ...
                  g.browser.msie && (g.events.disableBlur(),
              ...
              g.events.$on(g.$el, g._mouseup, "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', function(e) {
                  ...
                  t && (t = !1,
                  e.stopPropagation(),
                  g.browser.msie && (g.$el.attr("contenteditable", !0),
                  g.events.enableBlur()))
              }),
              ...
              g.events.$on(g.$el, g.helpers.isMobile() && !g.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', ne),
              g.helpers.isMobile() && (g.events.$on(g.$el, "touchstart", "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', function() {
                  a = !1
              }),
              g.events.$on(g.$el, "touchmove", function() {
                  a = !0
              })),
              g.$wp ? (g.events.on("window.keydown keydown", J, !0),
              g.events.on("keyup", function(e) {
                  if (d && e.which == be.FE.KEYCODE.ENTER)
                      return !1
              }, !0),
              g.events.$on(g.$el, "keydown", function() {
                  var e = g.selection.element();
                  e.nodeType === Node.TEXT_NODE && (e = e.parentNode),
                  g.node.hasClass(e, "fr-inner") || (g.node.hasClass(e, "fr-img-caption") || (e = be(e).parents(".fr-img-caption").get(0)),
                  be(e).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS),
                  g.selection.restore())
              })) : g.events.$on(g.$win, "keydown", J),
              g.events.on("toolbar.esc", function() {
                  if (d) {
                      if (g.$wp)
                          g.events.disableBlur(),
                          g.events.focus();
              ...
              g.events.on("toolbar.focusEditor", function() {
                  if (d)
                      return !1
              }, !0),
              g.events.on("window.cut window.copy", function(e) {
                  if (d && g.popups.isVisible("image.edit") && !g.popups.get("image.edit").find(":focus").length) {
                      var t = he();
                      ve() ? (t.before(be.FE.START_MARKER),
                      t.after(be.FE.END_MARKER),
                      g.selection.restore(),
                      g.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (ue(),
                      g.paste.saveCopiedText(d.get(0).outerHTML, d.attr("alt"))),
              ...
              g.browser.msie && g.events.on("keydown", function(e) {
                  if (!g.selection.isCollapsed() || !d)
                      return !0;
                  var t = e.which;
              ...
              g.events.$on(be(g.o_win), "keydown", function(e) {
                  var t = e.which;
                  if (d && t == be.FE.KEYCODE.BACKSPACE)
                      return e.preventDefault(),
                      !1
              }),
              ...
              g.opts.imageOutputSize && g.events.on("html.beforeGet", function() {
          ...
          showInsertPopup: function() {
              ...
              !t.hasClass("fr-active"))
                  if (g.popups.refresh("image.insert"),
                  ...
                  e.is(":visible")) {
                      ...
                      g.position.forSelection(t),
                      g.popups.show("image.insert")
          },
          showLayer: function(e) {
              ...
              !d && g.opts.toolbarInline && (a = i.offset().top - g.helpers.getPX(i.css("margin-top")),
          ...
          align: function(e) {
              ...
              !g.opts.htmlUntouched && g.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : pe(t, de(), e),
              ue(),
              C(),
              n(),
              g.selection.clear()
          ...
          display: function(e) {
              ...
              !g.opts.htmlUntouched && g.opts.useClasses ? "inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib") : pe(t, e, ge()),
              ue(),
              C(),
              n(),
              g.selection.clear()
          ...
          replace: ce,
          back: function() {
              d ? (g.events.disableBlur(),
              be(".fr-popup input:focus").blur(),
              k(d)) : (g.events.disableBlur(),
              g.selection.restore(),
              g.events.enableBlur(),
              g.popups.hide("image.insert"),
          ...
          applyStyle: function(e, t, a) {
              if (void 0 === t && (t = g.opts.imageStyles),
              ...
              "object" == typeof t[e] ? (i.removeAttr("style"),
              i.css(t[e].style)) : i.toggleClass(e),
              k(d)
          },
          showAltPopup: Y,
          showSizePopup: G,
          ...
          setSize: function(e, t) {
              if (d) {
                  ...
                  ve() && (d.parent().removeAttr("width").removeAttr("height"),
                  e.match(i) ? d.parent().css("width", e) : d.parent().css("width", ""),
                  t.match(i) ? d.parent().css("height", t) : d.parent().css("height", "")),
          ...
          toggleCaption: function() {
              ...
              if (d && !ve()) {
                  ...
                  var t = e.width();
                  e.wrap("<span " + (g.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + d.attr("class") + '" draggable="false"></span>'),
                  e.wrap('<span class="fr-img-wrap"></span>'),
                  e.after('<span class="fr-inner"' + (g.browser.mozilla ? "" : ' contenteditable="true"') + ">" + be.FE.START_MARKER + "Image caption" + be.FE.END_MARKER + "</span>"),
                  d.removeAttr("class").removeAttr("style").removeAttr("width"),
                  d.parents(".fr-img-caption").css("width", t + "px"),
                  se(!0),
                  g.selection.restore()
              } else
                  e = he(),
                  d.insertAfter(e),
                  d.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")),
                  e.remove(),
                  k(d)
          },
          hasCaption: ve,
  ...
  be.FE.RegisterCommand("imageBack", {
      ...
      refresh: function(e) {
          this.image.get() || this.opts.toolbarInline ? (e.removeClass("fr-hidden"),
      ...
      html: function() {
          ...
          for (var a in t)
              if (t.hasOwnProperty(a)) {
                  ...
                  e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="imageStyle" data-param1="' + a + '">' + this.language.translate(i) + "</a></li>"
              }
          return e += "</ul>"
      },
      callback: function(e, t) {
