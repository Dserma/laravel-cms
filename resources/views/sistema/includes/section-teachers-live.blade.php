<section class="section_teachers xs-text-center">
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-5 mb-5 mb-xl-0">
                <header class="section_teachers_header">
                    ...
                    <div class="more">
                        <a title="Ver todos os professores" href="{{ route('sistema.aluno.aovivo') }}">Ver todos os professores</a>
                    </div>
                </header>
            </div>
                ...
                <div class="section_teachers_list">
                    <div class="slick-teachers">
                        @foreach($professores as $professor)
                            <div class="px-3">
                                <article>
                                    <a class="photo" href="{{ route('sistema.aluno.aovivo.professor', $professor->slug) }}">
                                    ...
                                    <header>
                                        ...
                                        <p>Professor de @foreach($professor->categorias as $cat ){{ $cat->nome }} / @endforeach</p>
                                    </header>
                                </article>
                            </div>
                        @endforeach
